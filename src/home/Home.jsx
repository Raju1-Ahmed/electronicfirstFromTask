    ...
    return (
        <div className='menu-wrap'>
            ...
            <div className="Tab-wrap" id='tabWrap'>
                <ul>
                    <li className="tab active" data-tab="tab1 tab">
                    ...
                    <li className="tab active" data-tab="tab2">
                    ...
                    <li className="tab active" data-tab="tab3">
                    ...
                    <li className="tab active" data-tab="tab4 ">
            ...
            <div  className='platforms ' data-tab="tab4 tab-content " id="tab1" >
                <div className='view'>
                    <h2>Platforms</h2>
                    <a href="">View All</a>
                </div>
